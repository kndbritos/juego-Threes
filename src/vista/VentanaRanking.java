...
public class VentanaRanking extends JDialog {
    ...
    private void crearListaPuntajes(List<Integer> ranking) {
        ...
        if (estaVacio) {
            ...
            lblSinResultados.setFont(new Font("Arial", Font.BOLD, 14));

            panelPuntajes.add(lblSinResultados, BorderLayout.CENTER);
        } else {
        ...
        getContentPane().add(panelPuntajes, BorderLayout.CENTER);
    }
}